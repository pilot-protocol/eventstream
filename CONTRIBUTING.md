...
Thanks for your interest in contributing to `eventstream` — Pilot Protocol eventstream plugin — service port 1002, pub/sub event delivery.

## Quick start

```bash
git clone https://github.com/pilot-protocol/eventstream.git
cd eventstream
go test -race ./...
```
